#ifndef CTREECONVERTERNA49_H
#define CTREECONVERTERNA49_H
...
class CTreeConverterNA49 {

public:
	CTreeConverterNA49 ();
	CTreeConverterNA49 (TString inputFileName, TString outputFileName, TString inputTreeName);
