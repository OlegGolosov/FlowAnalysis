...
public:
    ...
    void SetFirstStep (Int_t firstStep = kNoCorrections);
    void SetLastStep (Int_t lastStep = kTwistAndRescale);
    void CalculateEP (Bool_t calculateEP = 1);
    void CalculateRP (Bool_t calculateRP = 1);

private:
	Int_t nHarmonics;
	Int_t *harmonicsMap;
	Int_t firstStep_, lastStep_;
